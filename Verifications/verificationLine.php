...
function exploreFile($path, $command, $numLines) {
    ...
    if (pathinfo($path, PATHINFO_EXTENSION) === 'png' || pathinfo($path, PATHINFO_EXTENSION) === 'jpg' || pathinfo($path, PATHINFO_EXTENSION) === 'jpeg' || pathinfo($path, PATHINFO_EXTENSION) === 'gif' || pathinfo($path, PATHINFO_EXTENSION) === 'svg' || pathinfo($path, PATHINFO_EXTENSION) === 'webp' || pathinfo($path, PATHINFO_EXTENSION) === 'json' || pathinfo($path, PATHINFO_EXTENSION) === 'md') {
        return;
    };
